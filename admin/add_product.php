    ...
    <main class="col-md-10 ms-sm-auto px-4 py-4">
      ...
      <form id="create-form" action="create_product.php" method="post" enctype="multipart/form-data" class="bg-white p-4 rounded shadow-sm" style="max-width:600px;">
        ...
        <div class="mb-3">
          ...
          <div>
            <input type="checkbox" name="sizes[]" id="size_s" value="S">
            <label for="size_s">S</label>
            
            <input type="checkbox" name="sizes[]" id="size_m" value="M">
            <label for="size_m">M</label>
            
            <input type="checkbox" name="sizes[]" id="size_l" value="L">
            <label for="size_l">L</label>
            
            <input type="checkbox" name="sizes[]" id="size_xl" value="XL">
